  ...
  return (
    <main className="landing-home">
      ...
      <section className="landing-hero">
        ...
        {/* 命盘档案 + 对话 mockup — 用户截图风格 */}
        <div className="landing-hero-mockup">
          <div className="landing-mockup-panel">
            <div className="landing-mockup-kicker">命 盘 档 案</div>
            <div className="landing-mockup-pillars">
              <div className="landing-mockup-cell">丁</div>
              <div className="landing-mockup-cell">酉</div>
              <div className="landing-mockup-cell landing-mockup-wide">食神格</div>
            </div>
          ...
          <div className="landing-mockup-panel">
            ...
            <p className="landing-mockup-bubble">
              可以继续问：这盘的核心矛盾是什么？接下来两年重点看什么？
            </p>
          </div>
        </div>
      </section>
