...
Plan 5 在 Plan 2+3+4 之上执行；Plan 5 cleanup 清掉 4 个 Important follow-ups（#1 timeout wire、#3 commit-before-done、#4 sms_send quota、#5 DEK contextvar reset）。**308 测试全绿** · 覆盖率 ≥85% · CI < 60s · wheel 可装可跑。
