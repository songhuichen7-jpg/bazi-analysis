...
KEYWORDS: dict[str, list[str]] = {
    ...
    # 用户问"用一首歌/一部电影/一本书/一种天气/一种气味形容我/这盘"等
    # 比喻型问题。前端会把回答里的 [[song:...]] / [[movie:...]] /
    # [[book:...]] / [[weather:...]] / [[scent:...]] token 渲染成卡片。
    "media":        ['用一首歌','用一支歌','用一首曲','用一部电影','用一部影片','用一部剧','用一部纪录片','用一本书','用一本小说','用一本散文','用一种天气','用天气','像什么天气','天气形容','用一种气味','用一种味道','用气味','用味道','用香水','香味形容','气味形容','味道形容','像哪首歌','像哪部电影','像哪本书'],
